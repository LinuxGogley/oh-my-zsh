...
* [Zsh](http://www.zsh.org) should be installed (v4.3.9 or more recent). If not pre-installed (`zsh --version` to confirm), check the following instruction here: [Installing ZSH](https://github.com/LinuxGogley/oh-my-zsh/wiki/Installing-ZSH)
...
```shell
sh -c "$(curl -fsSL https://raw.githubusercontent.com/LinuxGogley/oh-my-zsh/master/tools/install.sh)"
```

#### via wget

```shell
sh -c "$(wget https://raw.githubusercontent.com/LinuxGogley/oh-my-zsh/master/tools/install.sh -O -)"
```
